...
# Rebuild the CMF Phone 1 Evolution X 11.10 FeaturePack + SUExecFix v3 kernel.
# Usage: ./build-cmf-evox-featurepack-suexecfix-v3-kernel.sh [work-directory]
...
PATCH_FILE="$SCRIPT_DIR/CMF-Phone-1-EvolutionX-11.10-FeaturePack-KSUNext-SUSFS-SUExecFix-v3-source.patch"
KSU_PATCH_FILE="$SCRIPT_DIR/CMF-Phone-1-EvolutionX-11.10-KSUNext-SUSFS-SUExecFix-v3.patch"
