...
capture_dir="$script_dir/orangefox-r12-v4-logs-$capture_stamp"
...
adb shell 'getprop; echo; ps -AZ; echo; mount; echo; ls -l /dev/block/mapper 2>/dev/null' \
    > "$capture_dir/properties-processes-mounts.log" 2>&1 || true
